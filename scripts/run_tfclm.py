...
def main():
    ...
    column_name = "sequence" if "sequence" in column_names else column_names[0]
    # Log a few random samples from the training set:

    def tokenizer_function(examples):
        return fast_tokenizer(examples[column_name], 
    ...
    with training_args.strategy.scope():
        ...
        if training_args.save_strategy != "no":
            save_freq = training_args.save_steps if training_args.save_strategy == "steps" else training_args.save_strategy
            callbacks.append(
