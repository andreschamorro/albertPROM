...
def main():
    ...
    #
    # For CSV/JSON files, this script will use as labels the column called 'label' and as pair of read_1s the
    # read_1s in columns called 'read_1' and 'read_2' if such column exists or the first two columns not named
    # label if at least two columns are provided.
    #
    # If the CSVs/JSONs contain only one non-label column, the script does single read_1 classification on this
